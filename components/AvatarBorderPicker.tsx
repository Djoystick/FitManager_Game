...
const BORDERS = [
  ...
  },
  {
    ...
    label: 'Toxic Venom',
    cost: 2000,
    description: 'Pulsing toxic green',
    className: 'border-toxic-venom',
    preview: 'border-2 border-green-400 rounded-full border-toxic-venom',
  },
  {
    id: 'bloody-crimson',
    label: 'Bloody Crimson',
    cost: 2500,
    description: 'Heartbeat pulse',
    className: 'border-bloody-crimson',
    preview: 'border-2 border-red-600 rounded-full border-bloody-crimson',
  },
  {
    id: 'fire',
    label: 'Fire/Magma',
  ...
  },
  {
    ...
    label: 'Golden Leaves',
    cost: 4000,
    description: 'Autumn gold shimmer',
    className: 'border-golden-leaves',
    preview: 'border-2 border-yellow-500 rounded-full border-golden-leaves',
  },
  {
    id: 'cyber-glitch',
    label: 'Cyber Glitch',
    cost: 5000,
    description: 'Neon green + pink distortion',
    className: 'border-cyber-glitch',
    preview: 'border-2 border-green-400 rounded-full border-cyber-glitch',
  },
  {
    id: 'void-abyss',
    label: 'Void Abyss',
    cost: 6000,
    description: 'Cosmic purple-black void',
    className: 'border-void-abyss',
    preview: 'border-2 border-purple-900 rounded-full border-void-abyss',
  },
  {
    id: 'diamond-frost',
    label: 'Diamond Frost',
    cost: 7500,
    description: 'Icy crystalline shimmer',
    className: 'border-diamond-frost',
    preview: 'border-2 border-blue-200 rounded-full border-diamond-frost',
  },
  {
    id: 'electric-shock',
    label: 'Electric Shock',
    cost: 8500,
    description: 'Lightning flash bursts',
    className: 'border-electric-shock',
    preview: 'border-2 border-blue-300 rounded-full border-electric-shock',
  },
  {
    id: 'plasma-storm',
    label: 'Plasma Storm',
    cost: 10000,
    description: 'Flowing purple-pink plasma',
    className: 'border-plasma-storm',
    preview: 'border-2 border-purple-400 rounded-full border-plasma-storm',
  },
  {
    id: 'holographic',
    label: 'Holographic',
    cost: 15000,
    description: 'Rotating rainbow RGB',
    className: 'border-holographic',
    preview: 'border-2 border-white rounded-full border-holographic',
  },
];
