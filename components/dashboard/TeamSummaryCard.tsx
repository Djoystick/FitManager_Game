...
export function TeamSummaryCard({ teamOvr, tactic, avgStamina, injuredCount, language = 'en' }: Props) {
  ...
  return (
    <div className="h-full w-full rounded-xl border border-cyan-500/20 bg-cyan-500/5 p-3 flex flex-col justify-between gap-2 backdrop-blur-md hover:bg-cyan-500/10 transition-colors">
      ...
      <div className="grid grid-cols-2 gap-y-2 gap-x-1">
        ...
        <div className="col-span-2 flex justify-between items-center bg-black/20 rounded pl-1.5 pr-2 py-1">
